...
a = -9.8 # m/s2
dt = (tfinal - t0) / n
nbodies = 1000000 # numero de trayectorias a generar


theta = np.radians(np.random.randint(20, 85, nbodies))  # angulos aleatorios para cada una de las trayectorias
v_mag0 = np.random.randint(800, 1200, nbodies) # velocidades aleatorias entre 80 y 110 para cada una de las trayectorias
...
print(f"Demoró {tf - t0} segundos para {nbodies} partículas y {n} pasos de tiempo")
